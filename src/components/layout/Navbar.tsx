...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="fixed inset-x-0 top-0 z-[999] flex items-center justify-center px-8 py-[18px] bg-transparent">
        ...
        <div className="absolute right-8 flex items-center gap-3">
          <a href="#"
            className="hidden sm:block px-4 py-1.5 rounded-full border border-white/70
              text-white text-xs hover:bg-white/15 transition-colors duration-200">
            Book a demo
          </a>
          {/* Burger — simple, sans transformation X (le menu gère son propre X) */}
          <button
